...
namespace FUDChromeDriver
{
    ...
    {
        public static async Task WaitForExitPatchAsync(this Process process, CancellationToken cancellationToken = default)
        {
        ...
        private static Task _WaitForExitAsync(this Process process, CancellationToken cancellationToken = default)
        {
